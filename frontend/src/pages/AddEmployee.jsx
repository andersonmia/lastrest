...
const AddEmployee = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      await axios.post("http://localhost:3000/employees/add", employee, {
        headers: {
          ...
          <form onSubmit={handleSubmit}>
            <div className="flex flex-col space-y-4 md:space-y-6 mb-4">
              ...
              <div>
                ...
                <select
                  name="dpt"
                  value={employee.dpt}
                  onChange={(e) => handleChange("dpt", e.target.value)}
            ...
            <div className="flex flex-col space-y-4 md:space-y-6 mb-4">
              <FormInput
                ...
                onChange={(e) => handleChange("laptop_manufacturer", e.target.value)}
            ...
            <FormButton text="Add new employee" />
          </form>
        </div>
      </section>
    </div>
